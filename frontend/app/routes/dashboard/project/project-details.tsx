...
import type { TaskStatus,Task,Project } from '@/type/index.ts';
...
const ProjectDetails = () => {
    ...
    const {data, isLoading} = UseProjectQuery(projectId!) as { // thêm "!" => khẳng định nó chắc chắn có giá trị
        data:{
            tasks:Task[];
            project:Project;
        };
              ...
              <div className="flex gap-1">
                {task.status !== "To Do" && (
                  <Button
                    ...
                    title="Mark as To Do"
                    >
                    <AlertCircle className={clsx("w-[16px] h-[16px]")}/>
                ...
                {task.status !== "In Progress" && (
                   <Button
                    ...
                    title="Mark as To Do"
                    >
                    <Clock className={clsx("w-[16px] h-[16px]")}/>
                ...
                {task.status !== "Done" && (
                  <Button
                    ...
                    title="Mark as Done"
                  >
                    <CheckCircle className={clsx("w-[16px] h-[16px]")} />
                    ...
                    <div className='flex -space-x-2'>
                      {task.assignees.slice(0, 5).map((member)=>(
                        ...
                        >
                          ...
                          <AvatarFallback className='absolute top-[3%] left-[35%] text-[18px] text-[#f0fff0]'>{member.name.charAt(0)}</AvatarFallback>
                        </Avatar>
                      ))}
